...
public class FL_DistributionRange extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public FL_DistributionRange() {}

  /**
   * All-args constructor.
   */
  public FL_DistributionRange(java.util.List<influent.idl.FL_Frequency> distribution, influent.idl.FL_RangeType rangeType, influent.idl.FL_PropertyType type, java.lang.Boolean isProbability) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: distribution = (java.util.List<influent.idl.FL_Frequency>)value$; break;
    case 1: rangeType = (influent.idl.FL_RangeType)value$; break;
   ...
   */
  public java.util.List<influent.idl.FL_Frequency> getDistribution() {
    return distribution;
  }
   ...
   */
  public void setDistribution(java.util.List<influent.idl.FL_Frequency> value) {
   ...
   * Describes how the values in the distribution are summarised   */
  public influent.idl.FL_RangeType getRangeType() {
    return rangeType;
  }
   ...
   */
  public void setRangeType(influent.idl.FL_RangeType value) {
  ...
  /** Creates a new FL_DistributionRange RecordBuilder */
  public static influent.idl.FL_DistributionRange.Builder newBuilder() {
    return new influent.idl.FL_DistributionRange.Builder();
  }
  
  /** Creates a new FL_DistributionRange RecordBuilder by copying an existing Builder */
  public static influent.idl.FL_DistributionRange.Builder newBuilder(influent.idl.FL_DistributionRange.Builder other) {
    return new influent.idl.FL_DistributionRange.Builder(other);
  }
  
  /** Creates a new FL_DistributionRange RecordBuilder by copying an existing FL_DistributionRange instance */
  public static influent.idl.FL_DistributionRange.Builder newBuilder(influent.idl.FL_DistributionRange other) {
    return new influent.idl.FL_DistributionRange.Builder(other);
  }
  
  /**
   * RecordBuilder for FL_DistributionRange instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FL_DistributionRange>
    implements org.apache.avro.data.RecordBuilder<FL_DistributionRange> {
    ...
    private Builder() {
      super(influent.idl.FL_DistributionRange.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(influent.idl.FL_DistributionRange.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing FL_DistributionRange instance */
    private Builder(influent.idl.FL_DistributionRange other) {
            super(influent.idl.FL_DistributionRange.SCHEMA$);
      if (isValidValue(fields()[0], other.distribution)) {
        this.distribution = data().deepCopy(fields()[0].schema(), other.distribution);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'distribution' field */
    public influent.idl.FL_DistributionRange.Builder setDistribution(java.util.List<influent.idl.FL_Frequency> value) {
    ...
    public influent.idl.FL_DistributionRange.Builder clearDistribution() {
      distribution = null;
    ...
    /** Sets the value of the 'rangeType' field */
    public influent.idl.FL_DistributionRange.Builder setRangeType(influent.idl.FL_RangeType value) {
    ...
    public influent.idl.FL_DistributionRange.Builder clearRangeType() {
      rangeType = null;
    ...
    /** Sets the value of the 'type' field */
    public influent.idl.FL_DistributionRange.Builder setType(influent.idl.FL_PropertyType value) {
    ...
    public influent.idl.FL_DistributionRange.Builder clearType() {
      type = null;
    ...
    /** Sets the value of the 'isProbability' field */
    public influent.idl.FL_DistributionRange.Builder setIsProbability(boolean value) {
    ...
    public influent.idl.FL_DistributionRange.Builder clearIsProbability() {
      fieldSetFlags()[3] = false;
      return this;
    }

    @Override
    public FL_DistributionRange build() {
      try {
        FL_DistributionRange record = new FL_DistributionRange();
        record.distribution = fieldSetFlags()[0] ? this.distribution : (java.util.List<influent.idl.FL_Frequency>) defaultValue(fields()[0]);
        record.rangeType = fieldSetFlags()[1] ? this.rangeType : (influent.idl.FL_RangeType) defaultValue(fields()[1]);
