...
public interface FL_DataAccess {
  ...
  /** Returns a set of entities by uid. Typically requested with a summary level of detail,
	 ...
	 @param entities 	uids of entities to retrieve
	 @return 			entities */
  java.util.List<influent.idl.FL_Entity> getEntities(java.util.List<java.lang.String> entities, influent.idl.FL_LevelOfDetail levelOfDetail) throws org.apache.avro.AvroRemoteException;
  ...
  java.util.Map<java.lang.String,java.util.List<influent.idl.FL_Link>> getFlowAggregation(java.util.List<java.lang.String> entities, java.util.List<java.lang.String> focusEntities, influent.idl.FL_DirectionFilter direction, influent.idl.FL_LinkEntityTypeFilter entityType, influent.idl.FL_LinkTag tag, influent.idl.FL_DateRange date) throws org.apache.avro.AvroRemoteException;
  /** Returns links to other entities related to specify entities.  Each Link returned should
	 represent multiple records, used for displaying time series.
  ...
  /** Returns links to other entities related to specify entities. Each link returned should
	 ...
	 @param max				Trim the number of results this this value.
	 @return 				transactions for the set of entities */
  influent.idl.FL_TransactionResults getAllTransactions(java.util.List<java.lang.String> entities, influent.idl.FL_LinkTag tag, influent.idl.FL_DateRange date, influent.idl.FL_SortBy sort, java.util.List<java.lang.String> linkFilter, long start, long max) throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends FL_DataAccess {
    ...
    /** Returns a set of entities by uid. Typically requested with a summary level of detail,
	 ...
	 @param entities 	uids of entities to retrieve
	 @return 			entities */
    void getEntities(java.util.List<java.lang.String> entities, influent.idl.FL_LevelOfDetail levelOfDetail, org.apache.avro.ipc.Callback<java.util.List<influent.idl.FL_Entity>> callback) throws java.io.IOException;
    /** Returns a set of accounts for each given entity. Typically requested with a summary level of detail,
	 appropriate for card display and cluster summarisation. Full details are requested for 
	 detailed display views.
    ...
    /** Returns links to other entities related to specify entities. Each Link returned should
	 ...
	 @param date 			in the given date range
	 @return 				map of input entity IDs to an array of the links for that entity */
    void getFlowAggregation(java.util.List<java.lang.String> entities, java.util.List<java.lang.String> focusEntities, influent.idl.FL_DirectionFilter direction, influent.idl.FL_LinkEntityTypeFilter entityType, influent.idl.FL_LinkTag tag, influent.idl.FL_DateRange date, org.apache.avro.ipc.Callback<java.util.Map<java.lang.String,java.util.List<influent.idl.FL_Link>>> callback) throws java.io.IOException;
    /** Returns links to other entities related to specify entities.  Each Link returned should
	 represent multiple records, used for displaying time series.
    ...
    /** Returns links to other entities related to specify entities. Each link returned should
	 ...
	 @param max				Trim the number of results this this value.
	 @return 				transactions for the set of entities */
    void getAllTransactions(java.util.List<java.lang.String> entities, influent.idl.FL_LinkTag tag, influent.idl.FL_DateRange date, influent.idl.FL_SortBy sort, java.util.List<java.lang.String> linkFilter, long start, long max, org.apache.avro.ipc.Callback<influent.idl.FL_TransactionResults> callback) throws java.io.IOException;
  }
}