...
public class FL_PatternDescriptor extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** - ordered list of entity criteria for the pattern
		 - the first nodes in the ordered list represent stages earlier in the sequence of events
		 - CHANGED in 1.5: graphs may have cycles */
  @Deprecated public java.util.List<influent.idl.FL_EntityMatchDescriptor> entities;
  /** - link criteria between the entities above
		 - CHANGED in 1.5: graphs may have cycles */
  @Deprecated public java.util.List<influent.idl.FL_LinkMatchDescriptor> links;
   ...
   */
  public FL_PatternDescriptor(java.lang.CharSequence uid, java.lang.CharSequence name, java.lang.CharSequence description, java.util.List<influent.idl.FL_EntityMatchDescriptor> entities, java.util.List<influent.idl.FL_LinkMatchDescriptor> links) {
    this.uid = uid;
    this.name = name;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FL_PatternDescriptor>
    ...
    /** Sets the value of the 'uid' field */
    public influent.idl.FL_PatternDescriptor.Builder setUid(java.lang.CharSequence value) {
    ...
    /** Sets the value of the 'name' field */
    public influent.idl.FL_PatternDescriptor.Builder setName(java.lang.CharSequence value) {
    ...
    /** Sets the value of the 'description' field */
    public influent.idl.FL_PatternDescriptor.Builder setDescription(java.lang.CharSequence value) {
