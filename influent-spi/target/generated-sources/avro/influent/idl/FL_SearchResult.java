...
public class FL_SearchResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public FL_SearchResult(java.lang.Double matchScore, java.lang.Object result) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: matchScore = (java.lang.Double)value$; break;
  ...
  /**
   * Gets the value of the 'matchScore' field.
   * search match score   */
  public java.lang.Double getMatchScore() {
    return matchScore;
  }

  /**
   * Sets the value of the 'matchScore' field.
   * search match score   * @param value the value to set.
   */
  public void setMatchScore(java.lang.Double value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FL_SearchResult>
    ...
    private Builder(influent.idl.FL_SearchResult.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.matchScore)) {
        this.matchScore = data().deepCopy(fields()[0].schema(), other.matchScore);
    ...
    /** Sets the value of the 'matchScore' field */
    public influent.idl.FL_SearchResult.Builder setMatchScore(double value) {
    ...
    /** Checks whether the 'matchScore' field has been set */
    public boolean hasMatchScore() {
      return fieldSetFlags()[0];
    }
    
    /** Clears the value of the 'matchScore' field */
    public influent.idl.FL_SearchResult.Builder clearMatchScore() {
    ...
    public FL_SearchResult build() {
      try {
        ...
        record.matchScore = fieldSetFlags()[0] ? this.matchScore : (java.lang.Double) defaultValue(fields()[0]);
