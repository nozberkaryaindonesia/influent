...
public class FL_TransactionResults extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public FL_TransactionResults() {}

  /**
   * All-args constructor.
   */
  public FL_TransactionResults(java.lang.Long total, java.util.List<influent.idl.FL_Link> results) {
    this.total = total;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: results = (java.util.List<influent.idl.FL_Link>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * an array of transactions   */
  public java.util.List<influent.idl.FL_Link> getResults() {
    return results;
  }
   ...
   */
  public void setResults(java.util.List<influent.idl.FL_Link> value) {
    this.results = value;
  }

  /** Creates a new FL_TransactionResults RecordBuilder */
  public static influent.idl.FL_TransactionResults.Builder newBuilder() {
    return new influent.idl.FL_TransactionResults.Builder();
  }
  
  /** Creates a new FL_TransactionResults RecordBuilder by copying an existing Builder */
  public static influent.idl.FL_TransactionResults.Builder newBuilder(influent.idl.FL_TransactionResults.Builder other) {
    return new influent.idl.FL_TransactionResults.Builder(other);
  }
  
  /** Creates a new FL_TransactionResults RecordBuilder by copying an existing FL_TransactionResults instance */
  public static influent.idl.FL_TransactionResults.Builder newBuilder(influent.idl.FL_TransactionResults other) {
    return new influent.idl.FL_TransactionResults.Builder(other);
  }
  
  /**
   * RecordBuilder for FL_TransactionResults instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FL_TransactionResults>
    implements org.apache.avro.data.RecordBuilder<FL_TransactionResults> {

    private long total;
    private java.util.List<influent.idl.FL_Link> results;

    /** Creates a new Builder */
    private Builder() {
      super(influent.idl.FL_TransactionResults.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(influent.idl.FL_TransactionResults.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing FL_TransactionResults instance */
    private Builder(influent.idl.FL_TransactionResults other) {
            super(influent.idl.FL_TransactionResults.SCHEMA$);
      if (isValidValue(fields()[0], other.total)) {
        this.total = data().deepCopy(fields()[0].schema(), other.total);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'total' field */
    public influent.idl.FL_TransactionResults.Builder setTotal(long value) {
    ...
    public influent.idl.FL_TransactionResults.Builder clearTotal() {
    ...
    /** Sets the value of the 'results' field */
    public influent.idl.FL_TransactionResults.Builder setResults(java.util.List<influent.idl.FL_Link> value) {
    ...
    public influent.idl.FL_TransactionResults.Builder clearResults() {
      results = null;
    ...
    @Override
    public FL_TransactionResults build() {
      try {
        FL_TransactionResults record = new FL_TransactionResults();
        record.total = fieldSetFlags()[0] ? this.total : (java.lang.Long) defaultValue(fields()[0]);
        record.results = fieldSetFlags()[1] ? this.results : (java.util.List<influent.idl.FL_Link>) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
