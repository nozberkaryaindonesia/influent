...
public class FL_EntityMatchDescriptor extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<java.lang.CharSequence> entities;
  ...
  @Deprecated public java.util.List<influent.idl.FL_PropertyMatchDescriptor> properties;
  /** used for QBE -- not used to match like the entities list, this list of entities
		    should be used by the system to infer the above constraints when the user does not
		    provide them. */
  @Deprecated public java.util.List<java.lang.CharSequence> examplars;
  /** MUST_EQUALS, FUZZY_PARTIAL_OPTIONAL, MUST_NOT */
  @Deprecated public influent.idl.FL_Constraint constraint;
   ...
   */
  public FL_EntityMatchDescriptor(java.lang.CharSequence uid, java.lang.CharSequence role, java.util.List<java.lang.CharSequence> entities, java.util.List<influent.idl.FL_EntityTag> tags, java.util.List<influent.idl.FL_PropertyMatchDescriptor> properties, java.util.List<java.lang.CharSequence> examplars, influent.idl.FL_Constraint constraint) {
    this.uid = uid;
    this.role = role;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: entities = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: tags = (java.util.List<influent.idl.FL_EntityTag>)value$; break;
    case 4: properties = (java.util.List<influent.idl.FL_PropertyMatchDescriptor>)value$; break;
    case 5: examplars = (java.util.List<java.lang.CharSequence>)value$; break;
   ...
   * entities should match AT LEAST ONE OF the given entity IDs, if provided   */
  public java.util.List<java.lang.CharSequence> getEntities() {
    return entities;
  }
   ...
   */
  public void setEntities(java.util.List<java.lang.CharSequence> value) {
    this.entities = value;
  }
   ...
   * used for QBE -- not used to match like the entities list, this list of entities
		    should be used by the system to infer the above constraints when the user does not
		    provide them.   */
  public java.util.List<java.lang.CharSequence> getExamplars() {
    return examplars;
  }
   ...
   */
  public void setExamplars(java.util.List<java.lang.CharSequence> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FL_EntityMatchDescriptor>
    ...
    private java.util.List<java.lang.CharSequence> entities;
    ...
    private java.util.List<java.lang.CharSequence> examplars;
    ...
    /** Sets the value of the 'uid' field */
    public influent.idl.FL_EntityMatchDescriptor.Builder setUid(java.lang.CharSequence value) {
    ...
    /** Sets the value of the 'role' field */
    public influent.idl.FL_EntityMatchDescriptor.Builder setRole(java.lang.CharSequence value) {
    ...
    /** Sets the value of the 'entities' field */
    public influent.idl.FL_EntityMatchDescriptor.Builder setEntities(java.util.List<java.lang.CharSequence> value) {
    ...
    /** Sets the value of the 'examplars' field */
    public influent.idl.FL_EntityMatchDescriptor.Builder setExamplars(java.util.List<java.lang.CharSequence> value) {
    ...
    /** Sets the value of the 'constraint' field */
    public influent.idl.FL_EntityMatchDescriptor.Builder setConstraint(influent.idl.FL_Constraint value) {
    ...
    public influent.idl.FL_EntityMatchDescriptor.Builder clearConstraint() {
      constraint = null;
    ...
    public FL_EntityMatchDescriptor build() {
      try {
        ...
        record.entities = fieldSetFlags()[2] ? this.entities : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.tags = fieldSetFlags()[3] ? this.tags : (java.util.List<influent.idl.FL_EntityTag>) defaultValue(fields()[3]);
        record.properties = fieldSetFlags()[4] ? this.properties : (java.util.List<influent.idl.FL_PropertyMatchDescriptor>) defaultValue(fields()[4]);
        record.examplars = fieldSetFlags()[5] ? this.examplars : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[5]);
